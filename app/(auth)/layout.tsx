...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans flex items-center justify-center p-4 sm:p-6 md:p-8">
      ...
      <div className="w-full max-w-4xl bg-white rounded-2xl border border-slate-200 shadow-[0_4px_20px_-4px_rgba(15,23,42,0.05)] overflow-hidden grid grid-cols-1 md:grid-cols-12 min-h-[600px]">
        
        {/* Kolom Kiri: Visual Branding & Editorial Content (Asimetri Dinamis) */}
        <div className="md:col-span-5 bg-gradient-to-br from-blue-50 via-slate-50 to-blue-100/50 p-8 md:p-10 flex flex-col justify-between border-b md:border-b-0 md:border-r border-slate-200/80">
