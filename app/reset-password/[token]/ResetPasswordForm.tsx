    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {isLoading ? (
        ...
        <button
          ...
          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm py-2.5 px-4 rounded-lg transition-colors shadow-sm flex items-center justify-center gap-2 group disabled:bg-blue-200 disabled:cursor-not-allowed"
        >
